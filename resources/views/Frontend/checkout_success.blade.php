                        ...
                        <table class="table">
                            ...
                            @foreach($order->orderTransactions as $orderTransaction)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $orderTransaction->product->productProperties->where('property.property', 'Images')->first('value')->value) }}" height="50" alt="Image">
                                        {{ $orderTransaction->product->productProperties->where('property.property', 'Title')->first('value')->value }}
                                    </td>
